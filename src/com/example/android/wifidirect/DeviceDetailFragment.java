 ...
 */
public class DeviceDetailFragment extends Fragment implements GroupInfoListener {
...
//                        }
    ...
    public void onGroupInfoAvailable(final WifiP2pGroup group) {
       ...
       /* TextView view = (TextView) mContentView.findViewById(R.id.group_owner);
        ...
        // Group name
        TextView view = (TextView) mContentView.findViewById(R.id.group_name);
        view.setText(getResources().getString(R.string.group_name_text)+ group.getNetworkName());
        // Group password value
        view = (TextView) mContentView.findViewById(R.id.group_password);
        view.setText(getResources().getString(R.string.group_password_text)+ group.getPassphrase());
